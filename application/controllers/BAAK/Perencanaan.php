...
class Perencanaan extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('baak/perencanaan', $data);
    ...
    public function add() {
        ...
        $this->load->view('templates/baak/header');
        $this->load->view('templates/baak/sidebar');
        $this->load->view('baak/form_insert_perencanaan', $data);
        $this->load->view('templates/baak/footer');
    }
    ...
    public function edit($id) {
        ...
        $this->load->view('templates/baak/header');
        $this->load->view('templates/baak/sidebar');
        $this->load->view('baak/form_edit_perencanaan', $data);
        $this->load->view('templates/baak/footer');
    }
    ...
    public function info($id) {
        ...
        $this->load->view('templates/baak/header');
        $this->load->view('templates/baak/sidebar');
        $this->load->view('baak/info_perencanaan', $data);
        $this->load->view('templates/baak/footer');
    }
    ...
    public function insert_perencanaan() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(base_url('baak/perencanaan')); 
        }
    }

							...
							<div class="card-body">
								<div class="row">
                                    ...
                                    <?php foreach($dosen as $dsn): ?>
                                        <form method="POST" action="<?= base_url('baak/dosen/update_dosen')?>" enctype="multipart/form-data">
											...
											<div class="card-body">
												<div class="form-group">
													...
													<input type="text" name="kode_dosen" class="form-control" value="<?= $dsn->kode_dosen; ?>" readonly>
                                                ...
                                                <div class="form-group">
													<label>No Telp</label>
													<input type="text" name="no_telp" class="form-control" value="<?= $dsn->no_telp; ?>">
